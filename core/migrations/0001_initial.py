    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_a', models.ImageField(blank=True, null=True, upload_to='', verbose_name='lmage de la couverture side A')),
                ('cover_b', models.ImageField(blank=True, null=True, upload_to='', verbose_name='lmage de la couverture side B')),
        ...
        migrations.AddField(
            model_name='article',
            name='issue',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issue_of_article', to='core.issue'),
        ),
    ]
